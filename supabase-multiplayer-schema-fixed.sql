-- Multiplayer Game Rooms and Related Tables (FIXED VERSION)
...
-- Users can view players in rooms they're part of (FIXED - no recursion)
CREATE POLICY "Users can view room players" ON room_players
    FOR SELECT USING (user_id = auth.uid());

-- Users can join rooms (simplified check)
...
-- Users can view messages in rooms they're part of (FIXED - no recursion)
